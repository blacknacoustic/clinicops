          ...
          {selectedIds.length > 0 && (
            <div className="mb-4 p-3 bg-blue-600 rounded-lg shadow-lg flex items-center justify-between animate-in fade-in slide-in-from-top-2">
              ...
              <div className="flex gap-2">
                <button onClick={() => handleBulkStatus('COMPLETED')} className="bg-white/10 hover:bg-white/20 text-white px-4 py-1.5 rounded-md text-sm flex items-center gap-2">
                  <CheckCircle size={16} /> Mark Done
                </button>
                <button onClick={handleBulkDelete} className="bg-red-500 hover:bg-red-600 text-white px-4 py-1.5 rounded-md text-sm flex items-center gap-2">
